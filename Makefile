...
JSON_TEST_OBJS = json_test_runner.o intel8086.o
...
$(JSON_TEST_TARGET): $(JSON_TEST_OBJS)
	$(CC) -o $(JSON_TEST_TARGET) $(JSON_TEST_OBJS) -lcjson -lz
...
json_test_runner.o: json_test_runner.c intel8086.h opcode.h
